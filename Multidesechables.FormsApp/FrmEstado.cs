...
namespace Multidesechables.FormsApp
{
    public partial class FrmEstado : Form
    {
        ...
        public void ocultarMoverAncharColumnas()
        {
            ...
            tableProducts.Columns[7].Width = 130;
        ...
        {
            FrmMantenimientoEstado frm = new FrmMantenimientoEstado();
            frm.ShowDialog();
            frm.Update = false;
            mostrarTablaEstado();
            MostrarTotal();
        ...
        private void tableProducts_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                else if (tableProducts.Rows[e.RowIndex].Cells["editar"].Selected)
                {
                    ...
                    frm.txtpreciocompra.Text = tableProducts.Rows[e.RowIndex].Cells["PrecioCompra"].Value.ToString();
                    frm.txtprecioventa.Text = tableProducts.Rows[e.RowIndex].Cells["PrecioVenta"].Value.ToString();
                    frm.txtstockminmo.Text = tableProducts.Rows[e.RowIndex].Cells["Stockminimo"].Value.ToString();
                    frm.txtstockmaximo.Text = tableProducts.Rows[e.RowIndex].Cells["Stockmaximo"].Value.ToString();
